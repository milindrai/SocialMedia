...
const { register, login,logout,updatePassword,followUser,unfollowUser,getFollowers,getFollowing,updateProfile ,deleteUser,getUserProfile} = require("../controllers/user");
